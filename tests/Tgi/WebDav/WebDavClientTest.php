...
use GuzzleHttp\Message\RequestFactory;
use GuzzleHttp\Exception\BadResponseException;

/**
 * @covers Tgi\WebDav\Client
 */
class WebDavClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPropfindRetrievingNamedProperties()
    {
        ...
        $this->assertInstanceOf('Tgi\\WebDav\\MultiStatus', $result);
        $this->assertEquals(207, $status, 'Failed asserting that the status-code equals to 207 (Multi-Status)');
    }
    ...
    public function testSimpleLockRequest()
    {
        ...
        $this->assertInstanceOf('Tgi\\WebDav\\Lock', $lock);
    ...
    public function testRefreshingWriteLock()
    {
        ...
        $this->assertInstanceOf('Tgi\\WebDav\\Lock', $result);
