...
use Guzzle\Guzzle\Message\Response;
use Guzzle\Guzzle\Message\RequestFactory;
use Guzzle\Guzzle\Exception\BadResponseException;

/**
 * @covers Tgi\WebDav\Exception\HttpException
 */
class HttpExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testClientFailureException()
    {
        ...
        $this->assertInstanceOf('\Tgi\WebDav\Exception\ClientFailureException', $httpException);
    ...
    public function testServerFailureException()
    {
        ...
        $this->assertInstanceOf('\Tgi\WebDav\Exception\ServerFailureException', $httpException);
        $this->assertEquals((string)$this->request, $httpException->getRequest());
        $this->assertEquals((string)$response, $httpException->getResponse());
